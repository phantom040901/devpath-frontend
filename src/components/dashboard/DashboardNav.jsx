            ...
            <AnimatePresence>
              {careerOpen && (
                <motion.div
                  ...
                  className="absolute left-0 top-full mt-3 bg-gray-900 dark:bg-gray-900 light:bg-white backdrop-blur-xl border border-gray-700 dark:border-gray-700 light:border-gray-300 rounded-xl shadow-2xl w-56 py-2 overflow-hidden"
                  style={{ zIndex: 9100 }}
                  onMouseEnter={() => {
                    if (careerTimeout.current) clearTimeout(careerTimeout.current);
                    setCareerOpen(true);
