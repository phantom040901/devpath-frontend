  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[90rem] mx-auto px-24 py-32 max-xl:px-16 max-xl:py-24 max-lg:px-8 max-md:px-6">
        ...
        >
          <p className="text-primary-1300 bg-primary-500 primary-glow rounded-full px-4 py-2 text-sm font-semibold mb-6 inline-block">
            System Preview
          </p>
          <h2 className="text-primary-50 text-6xl font-extrabold tracking-tight mb-6 max-xl:text-5xl max-lg:text-4xl max-sm:text-3xl">
            See DevPath in Action
          </h2>
          <p className="text-primary-100 text-xl font-light max-w-3xl mx-auto max-xl:text-lg max-md:text-base">
            ...
            >
              ...
              <div className={index % 2 === 1 ? "md:col-start-2" : ""}>
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-3 rounded-xl bg-primary-1300/40 border border-primary-800">
                    {feature.icon}
                  </div>
                  <h3 className="text-primary-50 text-2xl font-bold max-lg:text-xl">
                    {feature.title}
                  </h3>
                </div>
                <p className="text-primary-200 text-lg leading-relaxed max-lg:text-base">
                  {feature.description}
                </p>
              </div>
              ...
              <div className={index % 2 === 1 ? "md:col-start-1 md:row-start-1" : ""}>
                <div className="relative group">
                  {/* Glow effect */}
                  <div className="absolute -inset-4 bg-gradient-to-r from-primary-500/20 to-purple-500/20 rounded-2xl blur-2xl group-hover:blur-3xl transition-all duration-300 opacity-50 group-hover:opacity-100" />

                  {/* Image container */}
                  <div className="relative bg-primary-1300/40 border border-primary-800 rounded-2xl p-2 shadow-2xl backdrop-blur-sm overflow-hidden">
                    <img
                      src={feature.image}
                      alt={feature.alt}
        ...
        >
          ...
          <a
            href="#hero"
            className="inline-block bg-gradient-to-r from-primary-500 to-cyan-400 text-primary-1300 font-bold px-10 py-4 rounded-full hover:scale-105 transition-all shadow-[0_0_30px_rgba(0,255,200,0.4)] hover:shadow-[0_0_50px_rgba(0,255,200,0.6)]"
          >
            Get Started Today
          </a>
        </motion.div>
