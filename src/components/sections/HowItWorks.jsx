...
export default function HowItWorks({ id }) {
  ...
  return (
    <section
      ref={sectionRef}
      id={id}
      className="dark:bg-primary-1500 light:bg-gray-50 overflow-hidden dark:bg-[url('../src/assets/Noise.webp')] bg-repeat pb-0"
    >
      <div className="dark:text-primary-50 light:text-gray-900 m-auto max-w-[90rem] px-6 sm:px-8 lg:px-16 xl:px-24 pt-16 sm:pt-18 lg:pt-20 xl:pt-24 pb-32 sm:pb-40 lg:pb-48 xl:pb-56">
        {/* Ambient glow */}
        ...
        {/* STEP 1 */}
        <div className="mb-12 md:mb-16 xl:mb-20 flex flex-col md:grid md:grid-cols-2 items-center gap-6 md:gap-10 lg:gap-16">
  ...
  <div className="order-2">
    <FadeInSection>
      <figure className="w-full flex justify-center">
        ...
        {/* STEP 3 */}
        <div className="flex flex-col md:grid md:grid-cols-2 items-center gap-6 md:gap-10 lg:gap-16">
          <div className="order-1 md:order-2">
            <FadeInSection>
              <div className="max-w-lg md:justify-self-end">
                <p className="mb-4 inline-flex items-center gap-3 text-sm uppercase tracking-[0.2em] dark:text-primary-300 light:text-primary-600">
