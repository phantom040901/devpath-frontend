                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs sm:text-sm text-gray-400">Tap any career to learn more</p>
                    </div>
                  </div>
                  ...
                  {detailedExplanations.map((explanation, idx) => {
                    ...
                    return (
                      <div key={idx} className={`rounded-xl border-2 overflow-hidden transition-all ${
                        match.isSelected
                          ? 'bg-gradient-to-br from-primary-500/20 to-emerald-500/10 border-primary-500/60 shadow-lg shadow-primary-500/20'
                        ...
                        <div className="p-4 sm:p-5">
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3 flex-1">
                              ...
                              <div className="flex-1 min-w-0">
                                <h3 className="text-lg sm:text-xl font-bold text-white truncate">{match.job_role}</h3>
                                <p className="text-xs text-gray-400">{match.category}</p>
                              </div>
                            </div>
                            <div className="flex-shrink-0 text-right ml-3">
                              <div className={`text-3xl sm:text-4xl font-black ${match.isSelected ? 'text-primary-400' : 'text-gray-400'}`}>
                                {match.match_score}
                              </div>
                              <div className="text-xs text-gray-500">Match</div>
                            </div>
                            ...
                            <div className="mb-4">
                              <div className="flex flex-wrap gap-2">
                                {explanation.your_strengths.slice(0, 3).map((strength, sIdx) => (
                                  <span key={sIdx} className="inline-flex items-center gap-1 text-xs bg-emerald-500/20 text-emerald-300 px-3 py-1.5 rounded-full border border-emerald-500/30">
                          ...
                          <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-primary-500/20 to-blue-500/10 hover:from-primary-500/30 hover:to-blue-500/20 border border-primary-500/30 hover:border-primary-500/50 transition-all group"
                          >
                        ...
                        <motion.div
                          ...
                          style={{ overflow: "hidden" }}
                        >
                          <div className="px-4 sm:px-5 pb-5 pt-2 border-t border-gray-700/30">
                            ...
                            {topFactors.length > 0 && (
                              <div className="space-y-3">
                                ...
                                {topFactors.map((factor, factorIdx) => {
                                  ...
                                  return (
                                    <div key={factorIdx} className="bg-gray-900/50 rounded-lg p-4 border border-gray-700/30">
                                      <div className="flex items-center justify-between mb-2">
                                        <span className="text-sm font-semibold text-white">{factor.feature}</span>
