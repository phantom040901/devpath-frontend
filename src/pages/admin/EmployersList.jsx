  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Manage and verify employer accounts</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        {/* Search and Filters */}
        <div className="bg-gray-900/70 border border-gray-800 rounded-xl p-6 mb-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:border-red-500 transition-colors"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:border-red-500 transition-colors"
              >
...
function EmployerCard({ employer, index, onApprove, onReject, onViewDetails }) {
  ...
  return (
    <motion.div
      ...
      className="bg-gray-900/70 border border-gray-800 rounded-xl p-6 hover:border-red-500/40 transition-all"
    >
      <div className="flex items-start justify-between gap-4">
        {/* Company Info */}
        <div className="flex-1">
          <div className="flex items-start gap-4 mb-4">
            <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center text-white font-bold text-xl">
          ...
          {/* Status Badge */}
          <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg border ${status.bg} ${status.border}`}>
          ...
          {employer.verificationStatus === "pending" && (
            <>
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-green-500/20 border border-green-500/40 text-green-400 hover:bg-green-500/30 transition-colors"
              >
                <CheckCircle size={16} />
                Approve
              </button>
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-lg bg-red-500/20 border border-red-500/40 text-red-400 hover:bg-red-500/30 transition-colors"
              >
                <XCircle size={16} />
                Reject
              </button>
